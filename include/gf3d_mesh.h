 ...
 * @param lightPos position for single lightColor
 * @param lightColor to color lighting
 */
 ...
 * @param uboData pointer to the UBO data for this draw
 * @param texture the texture to use (can be NULL for default)
 */
